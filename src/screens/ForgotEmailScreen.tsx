...
export default function ForgotEmailScreen({ navigation }: Props) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await apiService.forgotEmail(
      ...
      if (response.success && response.data) {
        ...
        showToast.error(
          "Error",
          response.message || "No account found with this client code.",
        );
      }
    } catch (error) {
      ...
      showToast.error(
        "Not Found",
        "No account found with this client code. Please verify your client code and try again.",
      );
    } finally {
      setLoading(false);
    }
  ...
  return (
    ...
    >
        ...
        {!showResult ? (
          <>
            ...
            <Text style={styles.subtitle}>
              Enter your client code to view your registered email address.
            </Text>
            ...
            <View style={styles.successContainer}>
              ...
              <View style={styles.infoBox}>
                ...
                <Text style={styles.infoText}>
                  If you don't recognize this email address or need further
      ...
      <CustomerCareModal
        ...
        message="If you do not recognize the email address shown or need help accessing your account, contact Customer Care and we will assist you."
      />
    </KeyboardAvoidingView>
  );
}
